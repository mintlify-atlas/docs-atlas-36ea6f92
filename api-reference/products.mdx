...
description: "Create, update, and archive products in Credith. Products can be assigned to multiple stores with independent stock levels and linked to one or more categories."
---
...
<ParamField body="description" type="string">
  A short description of the product. Stored as a string; omitted values are saved as `NULL`.
</ParamField>
