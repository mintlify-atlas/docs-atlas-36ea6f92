---
title: "Bills API — Create and Retrieve Tax-Compliant Invoices"
sidebarTitle: "Bills"
description: "Create invoices in Credith. The server validates the active CAI range, deducts inventory, and writes a cash or installment payment plan atomically."
---
