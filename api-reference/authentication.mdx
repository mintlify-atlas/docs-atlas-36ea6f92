---
title: "Credith API Authentication: JWT Cookies and Sessions"
sidebarTitle: "Authentication"
description: "Credith authenticates requests using JWT tokens stored in HTTP cookies. Log in to receive a signed token cookie; protected routes verify it automatically."
---
