...
description: "Query and manage per-store product inventory in Credith. Stock levels automatically decrement when invoices are created and can be updated directly via the inventory API."
---
