---
title: "Create a Sale and Issue a Honduran Invoice in Credith"
sidebarTitle: "Creating a Sale"
description: "Walk through Credith's bill creation: configure a CAI range, set up a checkout machine, select products, choose a payment type, and POST to /api/bills."
---
