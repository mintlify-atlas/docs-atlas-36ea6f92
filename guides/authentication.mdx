---
title: "Authenticate Users and Manage Sessions in Credith POS"
sidebarTitle: "Authentication"
description: "Credith uses JWT tokens stored in HTTP-only cookies. Log in to receive a token, then include the cookie on subsequent authenticated requests."
---
